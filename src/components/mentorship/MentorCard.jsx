...
export default function MentorCard({ mentor, index }) {
  return (
    <motion.div
      ...
      className="group rounded-2xl overflow-hidden bg-white/[0.02] border border-white/5 hover:border-amber-500/20 transition-all"
    >
      ...
      <div className="p-5">
        ...
        {mentor.linkedin && (
          <a 
            ...
            className="block mt-3 text-xs text-slate-600 hover:text-amber-400 transition-colors"
          >
            LinkedIn →
          </a>
        )}
