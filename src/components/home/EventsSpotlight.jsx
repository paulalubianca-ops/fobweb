        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-slate-500 text-lg leading-relaxed mb-6">
              Not another conference. Not a generic networking event. FoB runs hands-on experiences 
              — sprints, masterclasses, and workshops — designed specifically for founders at your stage.
            </p>
