        ...
        <div className="max-w-4xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-teal-900 mb-5">
              ...
              <span className="text-teal-600">ready to build.</span>
            </h1>
            <p className="text-lg text-slate-500 max-w-xl leading-relaxed">
              FoB bridges the gap between academia and the startup world — connecting Gen Z founders 
              with real mentors, real networks, and real context.
            </p>
          </motion.div>
        </div>
      </section>
