                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium text-slate-950 bg-amber-500 hover:bg-amber-400 rounded-full transition-colors duration-200"
                        >
